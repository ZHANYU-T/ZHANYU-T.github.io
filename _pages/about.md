...
<div style="display:flex; flex-wrap:wrap; gap:20px; margin-bottom:35px;">
  ...
  <p style="margin:6px 0;">
    ...
    <p style="margin:10px 0;">
      <a href="assets/papers/2602.13901v1.pdf" style="background:#b6bdc5; color:white; padding:6px 12px; border-radius:6px; text-decoration:none; margin-right:6px;">pdf</a>

      <a href="javascript:void(0);" onclick="toggleBlock('bibtex-paper1')" style="background:#b6bdc5; color:white; padding:6px 12px; border-radius:6px; text-decoration:none; margin-right:6px;">bibtex</a>

      <a href="javascript:void(0);" onclick="toggleBlock('abstract-paper1')" style="background:#b6bdc5; color:white; padding:6px 12px; border-radius:6px; text-decoration:none;">abstract</a>
    </p>
...
<!-- Buttons -->
    <p style="margin:10px 0;">
      ...
      <a href="javascript:void(0);" onclick="toggleBlock('abstract-paper2')" style="background:#b6bdc5; color:white; padding:6px 12px; border-radius:6px; text-decoration:none;">abstract</a>
    </p>
...
<!-- Buttons -->
    <p style="margin:10px 0;">
      ...
      <a href="javascript:void(0);" onclick="toggleBlock('abstract-3')" style="background:#b6bdc5; color:white; padding:6px 12px; border-radius:6px; text-decoration:none;">abstract</a>
    </p>
...
<!-- Buttons -->
    <p style="margin:10px 0;">
      ...
      <a href="javascript:void(0);" onclick="toggleBlock('abstract-4')" style="background:#b6bdc5; color:white; padding:6px 12px; border-radius:6px; text-decoration:none;">abstract</a>
    </p>
...
<!-- Buttons -->
    <p style="margin:10px 0;">
      ...
      <a href="javascript:void(0);" onclick="toggleBlock('abstract-5')" style="background:#b6bdc5; color:white; padding:6px 12px; border-radius:6px; text-decoration:none;">abstract</a>
    </p>
...
<!-- Buttons -->
    <p style="margin:10px 0;">
      ...
      <a href="javascript:void(0);" onclick="toggleBlock('abstract-9')" style="background:#b6bdc5; color:white; padding:6px 12px; border-radius:6px; text-decoration:none;">abstract</a>
    </p>
...
<!-- Buttons -->
    <p style="margin:10px 0;">
      ...
      <a href="javascript:void(0);" onclick="toggleBlock('abstract-11')" style="background:#b6bdc5; color:white; padding:6px 12px; border-radius:6px; text-decoration:none;">abstract</a>
    </p>
...
<!-- Buttons -->
    <p style="margin:10px 0;">
      ...
      <a href="javascript:void(0);" onclick="toggleBlock('abstract-10')" style="background:#b6bdc5; color:white; padding:6px 12px; border-radius:6px; text-decoration:none;">abstract</a>
    </p>
...
<!-- Buttons -->
    <p style="margin:10px 0;">
      ...
      <a href="javascript:void(0);" onclick="toggleBlock('abstract-6')" style="background:#b6bdc5; color:white; padding:6px 12px; border-radius:6px; text-decoration:none;">abstract</a>
    </p>
...
<!-- Buttons -->
    <p style="margin:10px 0;">
      ...
      <a href="javascript:void(0);" onclick="toggleBlock('abstract-7')" style="background:#b6bdc5; color:white; padding:6px 12px; border-radius:6px; text-decoration:none;">abstract</a>
    </p>
...
<!-- Buttons -->
    <p style="margin:10px 0;">
      ...
      <a href="javascript:void(0);" onclick="toggleBlock('abstract-8')" style="background:#b6bdc5; color:white; padding:6px 12px; border-radius:6px; text-decoration:none;">abstract</a>
    </p>
